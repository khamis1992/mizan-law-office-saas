...
describe('calculateSaasAnalytics', () => {
  it('calculates revenue, conversion, churn, and plan breakdown from known records', () => {
    ...
    const invoices: OpsInvoice[] = [{id:'i1',office_id:'office-a',grand_total:100,status:'paid',created_at:'2026-08-10T00:00:00Z'},{id:'i2',office_id:'office-b',grand_total:200,status:'issued',created_at:'2026-08-12T00:00:00Z'},{id:'i3',office_id:'office-b',grand_total:999,status:'cancelled',created_at:'2026-08-13T00:00:00Z'},{id:'i4',office_id:'office-a',grand_total:500,status:'paid',created_at:'2026-06-01T00:00:00Z'}];
